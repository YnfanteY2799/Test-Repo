...
function HeaderUserbox() {
  ...
  return (
    <>
      <Helmet>
        <title>Authentication - Tokyo React Typescript Admin Dashboard</title>
      </Helmet>
        ...
        <Grid container spacing={4}>
          ...
          <Grid item xs={12}>
            <Typography paragraph>
              Tokyo React Typescript Admin Dashboard includes four separate
            ...
            <Typography paragraph>
              ...
              default, Tokyo React Typescript Admin Dashboard comes with JWT Web
              Tokens enabled.
            </Typography>
            <Typography paragraph>
