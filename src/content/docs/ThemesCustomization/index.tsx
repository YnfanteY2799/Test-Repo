...
function ThemesCustomization() {
  ...
  return (
    <>
      <Helmet>
        <title>
          Themes Customization - Tokyo React Typescript Admin Dashboard
        </title>
      </Helmet>
        ...
        <Grid container spacing={4}>
          ...
          <Grid item xs={12}>
            <Typography paragraph>
              Tokyo React Typescript Admin Dashboard comes with 6 predefined
              color schemes.
            </Typography>
            <Typography paragraph>
              Three of them are 'light' color schemes: <code>Pure Light</code>,{' '}
              <code>Purple Flow</code> and <code>Grey Goose</code>. The other
              three are 'dark' color schemes: <code>Nebula Fighter</code>,{' '}
            ...
            <Typography paragraph>
              ...
              <code>src\theme\schemes\PureLightTheme.ts</code>:
            </Typography>
            <Prism
              showLineNumbers
              wrapLines
